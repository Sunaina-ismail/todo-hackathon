...
/**
 * Priority type - matches backend PriorityType
 */
export type Priority = 'High' | 'Medium' | 'Low'

/**
 * Tag interface for autocomplete - matches backend TagWithUsage
 */
...
/**
 * Task sort options - matches backend SortBy enum
 */
export type TaskSortBy =
  ...
  | 'priority_high_low'
  | 'alphabetical_az'
  // Simplified sort fields (mapped to backend values in actions)
  | 'created'
  | 'due_date'
  | 'priority'
  | 'title'
...
/**
 * Task list query parameters - matches backend API
 */
