...
### Example 3: Frontend API Client with JWT (Simple Pattern)
> **Note:** For production use with enhanced security, see [03-jwt-minting-server-actions.md](examples/03-jwt-minting-server-actions.md) which documents the recommended pattern with short-lived JWTs, issuer/audience validation, and custom claims.
...
> **Note:** For production with issuer/audience validation, see [02-backend-jwt-validation.md](examples/02-backend-jwt-validation.md) which documents the recommended pattern with full validation.
