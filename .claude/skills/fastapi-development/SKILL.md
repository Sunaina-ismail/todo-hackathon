...
> **Note:** For production with issuer/audience validation, see [better-auth/examples/02-backend-jwt-validation.md](../better-auth/examples/02-backend-jwt-validation.md) which documents the recommended pattern with full validation.
